...
function States(){
    const states = [{
       ...
       {getcity} </select>
        ...
        Landmarks :<select id="landmark" onChange={landmarkChanged}>
       {getlandmark} </select>
        <div id="state-name">
         <div id="state-title" >{state-title}</div>
         <div id="state-descrption" >{state-descrption}</div>
        </div>
        <div id="city-name">
         <div id="city-title" >{state-title}</div>
         <div id="city-descrption" >{state-descrption}</div>
        </div>
        <div id="landmark-name">
         <div id="landmark-title" >{state-title}</div>
         <div id="landmark-descrption" >{state-descrption}</div>
        </div> */}
        </>
     );
}
